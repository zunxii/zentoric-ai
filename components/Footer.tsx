    ...
    <footer className="bg-gray-900 text-white">
      <div className="container mx-auto px-4 md:px-6 py-12 md:py-16">
            ...
            <div className="flex items-center mb-6">
              <div className="relative h-8 w-8 mr-2">
                ...
                <div className="absolute inset-0.5 bg-gray-900 rounded-lg flex items-center justify-center">
                  <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 to-purple-400 font-bold">Z</span>
                </div>
              </div>
              <span className="font-extrabold text-xl text-white">Zentoric</span>
            </div>
            <p className="text-gray-400 mb-6">Transform your business with custom AI models. No machine learning expertise required.</p>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 mb-4 md:mb-0">© 2025 Zentoric. All rights reserved.</p>
